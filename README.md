Changes from default spirit code:
    ...
    4 boot selectable profiles:
      ...
      Usage:
         Hold menu button to change settings in the 3 profiles, then use the menu button to switch between settings, and trigger to change values. Long hold menu to exit and save settings to profile.
